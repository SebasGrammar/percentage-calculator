const calculator = document.querySelector("#calculator-9");
...
function update() {
    ...
    let x = ( Number(startingPrice.value) - Number(profit.value) ) - Number(percent.value) / 100 *  Number(startingPrice.value)
